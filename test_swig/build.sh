...
#for callback
#swig -c++ -python  my_callback_lib.i
clang++ -o _my_callback_lib.so -std=c++11 -fpic -shared my_cxx_class.cpp my_callback_lib_wrap.cxx $python_libs_include -L$python_libs_dir -lpython
